...
# iOS 26.5.1 Carrier Bundles

This repo contains the Carrier Bundles currently bundled with iOS version 26.5.1 for the iPhone Air.
## Last Extraction Metadata

#### Last Extraction Time
`2026-06-03 06:08:35 UTC`

#### iOS Build Info

| iOS Version | iOS Build | iOS Build Timestamp |
| :-------- | :------- | :------------------ |
| 26.5.1 | 23F81 | 18 Apr 2026 22:30:41 UTC |
